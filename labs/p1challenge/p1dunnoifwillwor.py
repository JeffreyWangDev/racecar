...
RED = ((130, 106, 128), (150, 170, 190)) 
BLUE = ((1, 226, 229), (25, 255, 255))
...
def update():
    ...
    if contour is not None:
        ...
        # Check if the contour center is within the cropped depth_image
        if contour_center[0] >= 0 and contour_center[0] < depth_image.shape[0] and \
           contour_center[1] >= 0 and contour_center[1] < depth_image.shape[1]:
            rc_utils.draw_contour(color_image_display, contour)
            rc_utils.draw_circle(color_image_display, contour_center)
